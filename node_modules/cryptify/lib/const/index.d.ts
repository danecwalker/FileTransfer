import { Commands, Options, DefaultValues } from './types';
export declare const IV_BLOCK_LENGTH = 16;
/**
 ...
 */
export declare const DEFAULT: DefaultValues;
/**
...
export declare const SupportedCiphers: string[];
